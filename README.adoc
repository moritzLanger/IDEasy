...
image:https://coveralls.io/repos/github/moritzLanger/IDEasy/badge.svg?branch=main(Coverage Status)!:https://coveralls.io/github/moritzLanger/IDEasy?branch=main
