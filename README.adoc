...
image:[![Coverage Status](https://coveralls.io/repos/github/moritzLanger/IDEasy/badge.svg?branch=main)](https://coveralls.io/github/moritzLanger/IDEasy?branch=main)
